...
> [![](https://img.youtube.com/vi/QJOLpta1FPU/0.jpg)](https://youtu.be/QJOLpta1FPU)
...
* How did we get here? Where are we going?
    * Physical/Colo
        * User-configured, managed, amd maintained
    * Virtualized
        * User-configured
        * Provider-managed and maintined
    * Serverless
        * Fully automated
...
* Security is designed into Google's technical infrastructure
    * Operational security
        * Intrusion detection systems; techniques to reduce insider risk; employee U2F; software development practices
    * Internet communication
        * Google Front-End (GFE), designed-in Denial of Service protection
    * Storage services
        * Encryption at rest
    * User identity
...
* Report is a visual tool to monitor expenditure
* Quotas are designed to prevent the over-consumption of resources, whether because of error or malicious attack.
...
5. Which statement is true about the zones within a region?
    * a. The zones within a region have fast network connectivity among them.
    * b. Customers must choose exactly one zone in each region in which to run their resources.
    * c. Each zone corresponds to a single physical data center.
